export const TITLE: string = '¿Quién diseñará la papelería de tu boda?';

export const TEXT: string = `<p>¡Hola!
  <br><br>
  ...
  <br>
  invitación, los invitados sientan un adelanto de la magia que les espera.</p>`;
